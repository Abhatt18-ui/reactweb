...
import PaymentSuccessModal from './PaymentErrorModal';
import PaymentErrorModal from './PaymentErrorModal';

const CheckoutOrderSummary = () => {
 const {onClose: onErrorClose, onOpen: onErrorOpne, isOpen: isErrorOpen} = useDisclosure();
 const {onClose: onSuccessClose, onOpen: onSuccessOpne, isOpen: isSuccessOpen} = useDisclosure();
...
<Divider bg={mode('gray.400', 'gray.800')} />
 ...
 <PaymentErrorModal onClose= {onErrorClose } onOpen ={onErrorOpne } isOpen={isErrorOpen}/>
 <PaymentSuccessModal onClose= {onSuccessClose } onOpen ={onSuccessOpne } isOpen={isSuccessOpen}/>
</Stack>
  );
};
