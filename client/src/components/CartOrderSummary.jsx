...
const CartOrderSummary = () => {
    ...
    const standerdShipping = Number(4.99).toFixed(2);
  ...
  return <Stack spacing='8' borderWidth='1px' rounded= 'lg' padding='8' w='full'>
   ...
   <Stack spacing='6'>
    ...
    <Flex justify='space-between'>
        ...
        <Text fontSize='xl' fontWeight='extrabold'>
           $ {subtotal <=1000 ? Number(subtotal) + Number(standerdShipping) : subtotal}
            </Text>        
    </Flex>
   </Stack>
   <Button as={ReactLink} 
   ...
   size='lg' 
   fontSize='md' 
   rightIcon={<FaArrowRight/>} isLoading={buttonLoading} onClick={()=> checkoutHandler()}>
    Checkout
   </Button>
  </Stack>
};
